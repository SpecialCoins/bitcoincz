...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-port=<port>", strprintf(_("Listen for connections on <port> (default: %u or testnet: %u)"), 29500, 29500));
    ...
    strUsage += HelpMessageOpt("-litemode=<n>", strprintf(_("Disable all BCZ specific functionality (Masternodes, SwiftX) (0-1, default: %u)"), 0));

#ifdef ENABLE_WALLET
    strUsage += HelpMessageGroup(_("Staking options:"));
    strUsage += HelpMessageOpt("-stake=<n>", strprintf(_("Enable staking functionality (0-1, default: %u)"), 1));
    ...
    strUsage += HelpMessageOpt("-rpcport=<port>", strprintf(_("Listen for JSON-RPC connections on <port> (default: %u or testnet: %u)"), 29501, 29501));
...
bool AppInit2()
{
    ...
    if (fDisableWallet) {
        ...
        if (SoftSetBoolArg("-stake", false))
            LogPrintf("AppInit2 : parameter interaction: wallet functionality not enabled -> setting -stake=0\n");
#ifdef ENABLE_WALLET
    } else {
...
// ********************************************************* Step 5: Backup wallet and verify wallet database integrity
    ...
    if (!fDisableWallet) {
        ...
        nWalletBackups = GetArg("-createwalletbackups", 25);
