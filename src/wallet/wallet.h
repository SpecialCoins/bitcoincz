...
static const unsigned int DEFAULT_CREATEWALLETBACKUPS = 25;
...
public:
    ...
    // Check whether staking status is active (last attempt earlier than 300 seconds ago)
    bool IsActive() const { return (nTime + 300) >= GetTime(); }
};
...
public:
    ...
    /// Get BCZ output and keys which can be used for the Masternode
