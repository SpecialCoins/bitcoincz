...
#include "qt/bcz/coincontrolwidget.h"
#include "qt/bcz/forms/ui_coincontrolwidget.h"

CoinControlBczWidget::CoinControlBczWidget(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::CoinControlBczWidget)
{
    ui->setupUi(this);
    ...
    ui->labelTitle->setText("Select BCZ Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("BCZ");
    ...
    ui->labelValueAfter->setText("0.00 BCZ");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 BCZ");
    ui->labelValueFee->setText("0.00 BCZ");
...
CoinControlBczWidget::~CoinControlBczWidget()
{
    delete ui;
}
