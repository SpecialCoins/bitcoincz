...
#include "qt/bcz/settings/settingsnetworkwidget.h"
#include "qt/bcz/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/bcz/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(BCZGUI* _window, QWidget *parent) :
